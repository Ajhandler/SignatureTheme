		...
		<main id="main" class="site-main" role="main">
			...
			<section class="error-404 not-found">
				...
				<div class="page-content">
					...
					<?php if ( signature_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>
					...
					<?php
						...
						$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'signature' ), convert_smilies( ':)' ) ) . '</p>';
